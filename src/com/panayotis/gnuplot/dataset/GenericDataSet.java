...
public class GenericDataSet extends ArrayList<ArrayList<String>> implements DataSet {
    ...
    */ 
    public GenericDataSet () {
     ...
     /**
     * Create a new instance of GenericDataSet, with the default DataParser (DoubleDataParser),
     * and the information that the first column is in date format.
...
public int getDimensions() {
     ...
     * @throws java.lang.NumberFormatException If the given collection is not in the correct format
     */
